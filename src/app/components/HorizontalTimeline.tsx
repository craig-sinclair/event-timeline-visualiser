...
export default function HorizontalTimeline({ events }: { events: EventData[] }) {
  return (
    <div className="mx-auto relative px-2 xs:px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 2xl:px-30 pt-12 xs:pt-16 sm:pt-24 md:pt-32 lg:pt-50 pb-12 xs:pb-16 sm:pb-24 md:pb-32 lg:pb-48">
