...
export async function populateData() {
    ...
    try {
        ...
        const ukClimateEventsDataPath = path.join(process.cwd(), "src/app/data/sample-uk-climate-data.json");
        ...
        const ukClimateTimeline = timelinesData.find((t: TimelineData) => t.title === "UK Response to Climate Change");
